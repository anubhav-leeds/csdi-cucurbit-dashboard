...
index.html
csdi_cucurbit_dashboard.html
maps/
legends/
README.md
.nojekyll

index.html and csdi_cucurbit_dashboard.html contain the same dashboard. The index.html file is included because GitHub Pages automatically opens it as the default webpage.

The maps/ folder contains all pre-rendered map images used by the interactive dashboard.

The legends/ folder contains the colour-bar legends.

Recommended citation

If using this dashboard in a presentation, manuscript, or report, please cite the associated field-experiment study and the dashboard repository.

Suggested wording:

This dashboard uses field-experiment-derived Composite Sowing Dates Index values from Smiti et al. (2026) as biological anchors and combines them with National Aeronautics and Space Administration Earth Exchange Global Daily Downscaled Projections, Coupled Model Intercomparison Project Phase 6 growing-window climate metrics to map Composite Sowing Dates Index-informed thermal analogue suitability over India.

Contact

For questions about the dashboard workflow, interpretation, or manuscript use, please contact the repository owner.
